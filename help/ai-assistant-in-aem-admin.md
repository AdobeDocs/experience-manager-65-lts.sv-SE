...
1. På sidan **Användargrupper** för **AI-assistenten i AEM** klickar du på fliken **Användare** och sedan på **Lägg till användare**.
   ...
   ![AI-assistenten på sidan för AEM-användargrupper som visar fliken Användare och knappen Lägg till användare](/help/assets/assets-ai/ai-assistant-add-users.png)
