...
1. På sidan **[!UICONTROL Dynamic Media Cloud Settings]**, under **[!UICONTROL Video Service URL]**, kopierar du ned hela URL-sökvägen. Du måste gå till den kopierade URL-sökvägen senare i stegen.

   URL-sökvägen kan till exempel se ut ungefär så här:

   `https://s7athens.macromedia.com:9090/DMGateway/`

   (Sökvägen ovan är endast ett exempel. Det är inte den verkliga sökvägen som du kopierar.)
...
1. I närheten av det övre vänstra hörnet av sidan väljer du **[!UICONTROL Cloud Services]**, sedan Experience Manager logotyp och går till **[!UICONTROL General]** > **[!UICONTROL CRXDE Lite]**.
