...
[Snabbstart (SOAP-läge): Tillämpa en profil på ett PDF-dokument med Java API](#quick-start-soap-mode-applying-a-policy-to-a-pdf-document-using-the-java-api)

[Snabbstart (SOAP-läge): Ta bort en profil från ett PDF-dokument med Java API](document-security-service-java-api.md#quick-start-soap-mode-removing-a-policy-from-a-pdf-document-using-the-java-api)
...
[Snabbstart (SOAP-läge): Inspektera policyskyddade PDF-dokument med Java API](document-security-service-java-api.md#quick-start-soap-mode-inspecting-policy-protected-pdf-documents-using-the-java-api)
...
I följande Java-kodexempel skapas en ny princip med namnet *Tillåt kopia*. Principuppsättningen som principen läggs till i har namnet *Global principuppsättning*. Den här principuppsättningen finns som standard. (Se [Skapa profiler](/help/forms/developing/protecting-documents-policies.md#creating-policies).)
...
I följande Java-kodexempel tas en princip bort med namnet *Tillåt kopia*. (Se [Ta bort profiler](/help/forms/developing/protecting-documents-policies.md#deleting-policies).)
...
I följande Java-kodexempel tillämpas en princip med namnet *Allow Copy* i ett PDF-dokument med namnet *Loan.pdf*. Principuppsättningen som principen läggs till i har namnet *Global principuppsättning*. Det principskyddade dokumentet sparas som en PDF-fil med namnet *PolicyProtectedLoanDoc.pdf. *(Se [Tillämpa principer i PDF-dokument](/help/forms/developing/protecting-documents-policies.md#applying-policies-to-pdf-documents).)
...
## Snabbstart (SOAP-läge): Ta bort en profil från ett PDF-dokument med Java API {#quick-start-soap-mode-removing-a-policy-from-a-pdf-document-using-the-java-api}
...
I följande Java-kodexempel ändras vattenstämpeln *Konfidentiellt* genom att värdet för attributet `opacity` ändras till 80.
...
I följande Java-kodexempel tillämpas en princip med namnet *Tillåt kopia* i ett Word-dokument med namnet *Loan.doc*. Principuppsättningen som principen läggs till i har namnet *Global principuppsättning*. Det principskyddade dokumentet sparas som en DOC-fil med namnet *PolicyProtectedLoanDoc.doc. *(Se [Tillämpa principer i PDF-dokument](/help/forms/developing/protecting-documents-policies.md#applying-policies-to-pdf-documents).)
...
## Snabbstart (SOAP-läge): Skydda en PDF i ett Statement-arbetsflöde för en befintlig användare med Java API {#quick-start-soap-mode-protect-a-pdf-in-statement-workflow-for-an-existing-user-using-the-java-api}
...
## Snabbstart (SOAP-läge): Skydda en PDF i ett Statement-arbetsflöde för en ny användare med Java API {#quick-start-soap-mode-protect-a-pdf-in-statement-workflow-for-a-new-user-using-the-java-api}
