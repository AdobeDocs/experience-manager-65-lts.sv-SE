...
## Snabbstart (SOAP-läge): Återge en stödlinje (föråldrat) med Java™ API {#quick-start-soap-mode-rendering-a-guide-deprecated-using-the-java-api}
...
I följande kodexempel återges ett HTML-formulär med Forms klient-API. Namnet på den anpassade CSS-filen som refereras är *custom.css*. (Se [Återge HTML Forms med anpassade CSS-filer](/help/forms/developing/rendering-forms.md#rendering-html-forms-using-custom-css-files).)
...
I följande kodexempel återges ett HTML-formulär med ett verktygsfält som visas på franska. Platsen för fscmenu.xml är C:\Adobe (den här mappen måste finnas på den server där AEM Forms finns). Observera att språkvärdet är `fr_FR`. I avsnittet som beskriver hur ett HTML-formulär återges med ett anpassat verktygsfält visas syntaxen för filen fscmenu.xml som används i snabbstarten. (Se [Återge HTML Forms med anpassade verktygsfält](/help/forms/developing/rendering-forms.md#rendering-html-forms-with-custom-toolbars).)
...
## Snabbstart (SOAP-läge): Förifyll Forms med flödeslayouter med Java™ API {#quick-start-soap-mode-prepopulating-forms-with-flowable-layouts-using-the-java-api}
