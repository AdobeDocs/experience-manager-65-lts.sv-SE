---
title: Åtgärder och funktioner i formulärbaserade AEM-arbetsflöden för OSGi- och AEM Forms JEE-arbetsflöden
description: Åtgärder och funktioner i formulärbaserade AEM-arbetsflöden för OSGi- och AEM Forms JEE-arbetsflöden
...
# Åtgärder och funktioner i formulärbaserade AEM-arbetsflöden för OSGi- och AEM Forms JEE-arbetsflöden {#actions-and-capabilities-of-form-centric-aem-workflows-on-osgi-and-aem-forms-jee-workflows}

## AEM Inbox och HTML Workspace {#aem-inbox-and-html-workspace}

Du kan använda AEM Inbox för att köra och övervaka Forms-centrerade AEM-arbetsflöden på OSGi. I HTML Workspace kan du köra och övervaka AEM Forms JEE-arbetsflöden. Följande tabell hjälper dig att förstå olika viktiga åtgärder som är tillgängliga i AEM Inbox för Forms-centrerade AEM-arbetsflöden i OSGi och i HTML Workspace för AEM Forms JEE-arbetsflöden.
...
<table>
 <tbody>
  ...
  <tr>
   <td>Integrering med andra AEM-lösningar</td>
   <td>Stöds</td>
   <td>Stöds</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Rendera den färdiga uppgiften som anpassat formulär eller PDF-dokument</td>
   <td>Stöds</td>
   <td>Stöds [4]</td>
  </tr>
  <tr>
...
1. Du kan använda formulärbaserade AEM-arbetsflöden i OSGi för att signera ett ifyllt anpassat formulär. Formulärbaserade AEM-arbetsflöden i OSGi har stöd för formulärsignering. Signeringsfunktionen [i form](../../forms/using/working-with-adobe-sign.md#create-in-form-signing-experience) stöds inte.

1. Du måste ha tillgång till AEM Inbox för att kunna köra och övervaka Form-Centric-arbetsflöden i AEM Forms OSGi och HTML Workspace för att kunna köra och övervaka AEM Forms JEE-arbetsflöden.
1. AEM Forms Document Services finns för både formulärbaserade AEM-arbetsflöden i OSGi och AEM Forms i JEE-arbetsflöden. AEM Workflow använder inbyggda dokumenttjänster för blankettbaserade AEM-arbetsflöden i OSGi- och AEM Forms JEE-arbetsflöden (Process Management).
...
1. AEM formulär-JEE-arbetsflöden har inte ett separat steg för Adobe Sign. Du behöver ett anpassningsbart formulär aktiverat i Adobe Sign för JEE-arbetsflöden i AEM-formulär. Mer information finns i [Adobe Sign-dokumentation](../../forms/using/working-with-adobe-sign.md#add-and-configure-the-signature-step-component).
