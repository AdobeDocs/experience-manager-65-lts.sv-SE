...
+ Webbplatser {#sites}
   + Redigering {#authoring}
      ...
      + Sidprestanda {#page-performance}
         + [Content Insight](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/authoring/siteandpage/content-insights.html?lang=sv-SE)
...
+ Forms {#forms}
   ...
   + Komma igång {#getting-started}
      ...
      + [Introduktion till tjänsten Automatiserad formulärkonvertering](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/introduction.html?lang=sv-SE)
   ...
   + Installera och konfigurera AEM Forms {#install-aem-forms}
      ...
      + [Installations- och uppgraderingsarbetsflöde för AEM Forms i JEE](/help/forms/using/aem-forms-jee-installation-upgrade-documentation.md)
      + Installera AEM Forms i JEE {#jee-installation}
         ...
         + [Installation av AEM Forms (en server) förbereds](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-install-single-server.pdf)
         + [Installationsguide för databasarkiv (fristående läge)](/help/forms/using/database-credentials-store-setup-guide-standalone-mode.md)
         + [Lagringsinställningar för databasautentiseringsuppgifter (Elytron-baserad)](/help/forms/using/database-credential-store-setup-elytron-based.md)
         + [Installation av sekundär nodautentisering (Elytron-baserad)](/help/forms/using/secondary-node-authentication-setup-elytron-based.md)
      + Installera AEM Forms på OSGi {#osgi-installation}
         ...
         + [Installera och konfigurera tjänsten Automatisk formulärkonvertering](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html?lang=sv-SE)
      ...
      + Konfigurera AEM Forms {#configure-aem-forms}
         ...
         + [Konfigurera AEM Forms på JEE i JBoss-kluster](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/cluster-jboss.pdf)
   + Uppgradera AEM Forms {#upgrade-aem-forms}
      ...
      + Uppgradera AEM Forms på OSGi {#aem-forms-osgi-upgrade}
         ...
         + [Uppgraderar AEM 6.5 LTS i JBoss EAP 8 (Windows)](/help/forms/using/upgrading-aem-65-lts-on-jboss-eap-8.md)
      + Uppgradera AEM Forms på JEE {#aem-forms-jee-upgrade}
         + [Uppgradera till AEM Forms 6.5 LTS on JEE for JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-turnkey.pdf)
         + [Uppgradera till AEM Forms på JEE för JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-jboss.pdf)
         + [Förbereder uppgradering av AEM Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-upgrade.pdf)
   ...
   + Adaptiv Forms - grundläggande redigering {#adaptive-forms-basic-authoring}
      ...
      + [Ansluta och skicka data i adaptiva blanketter till Microsoft® Power Automate](/help/forms/using/forms-microsoft-power-automate-integration.md)
   ...
   + AEM Forms {#aem-forms-app}
      ...
      + [Konfigurera Android™ studio-projektet och bygg appen Android™](/help/forms/using/setup-android-studio-project-build-installer.md)
   ...
   + Forms Designer {#use-forms-designer}
      ...
      + [Självstudiekurser för att komma igång med Designer](https://www.adobe.com/go/learn_aemforms_designer_quick_start_65)
   ...
   + Administratörshjälp för AEM Forms i JEE {#administrator-help}
      ...
      + Konfigurerar SSL {#configure-ssl}
         ...
         + [Konfigurera SSL för JBoss® Application Server](/help/forms/using/admin-help/configuring-ssl-for-jboss-application-server-aem-forms-65-lts-jee.md)
      ...
      + Underhåll programservern {#manage-application-server}
         ...
         + [Starta och stoppa WebSphere® Application Server](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
      + Säkerhetskopiering och återställning av AEM-formulär {#aem-forms-backup-recovery}
         ...
         + [Säkerhetskopieringsstrategi för Connector för EMC Documentum®-användare](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
   ...
   + Referens för utvecklare {#developer-reference}
      ...
      + [AEM plug-in för att felsöka adaptiva formulär](https://adobe-consulting-services.github.io/acs-aem-tools/aem-chrome-plugin/adaptive-form/)
      + [Formulär-API:er för HTML5-formulär](/help/forms/using/form-bridge-apis.md)
      + [JavaScript Library API reference for Adaptive Forms](https://helpx.adobe.com/se/experience-manager/6-5/forms/javascript-api/index.html)
   ...
   + Felsökning {#troubleshooting}
      ...
      + [Skriptkörning misslyckas på AEM Forms 6.5 LTS med JBoss EAP 8 (Linux)](/help/forms/using/script-execution-issues-on-aem-forms-65-lts-with-jboss-eap-8-linux.md)
      + [Det går inte att starta JBoss-domänkontrollanten](/help/forms/using/unable-to-start-jboss-domain-controller-due-to-duplicate-security-tag.md)
...
+ Headless {#headless}
   ...
   + AEM Headless Developer Journey {#developer}
      ...
      + [Komma igång med AEM Headless](/help/journey-headless/developer/getting-started.md)
...
+ Implementering {#implementing}
   + Utvecklar {#developing}
      + Introduktion för utvecklare {#introduction}
         ...
         + [Säkerhet](/help/sites-developing/security.md)
      ...
      + Plattform {#platform}
         ...
         + Taggning{#tagging}
            + [Taggning](/help/sites-developing/tags.md)
      ...
      + Headless Experience Management {#headless}
         ...
         + Huvudlösa resor {#journeys}
            + Headless Developer Journey {#developer}
               + [Förstå Headless i AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/overview.html?lang=sv-SE)
               ...
               + [Vägen till din första upplevelse med AEM Headless](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/path-to-first-experience.html?lang=sv-SE)
               + [Så här modellerar du innehåll som AEM Content Models](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/model-your-content.html?lang=sv-SE)
               + [Så här kommer du åt ditt innehåll via AEM API:er](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/access-your-content.html?lang=sv-SE)
               ...
               + [Hur man sammanför allt](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/put-it-all-together.html?lang=sv-SE)
               + [Så här lever du med ditt headless-program](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/go-live.html?lang=sv-SE)
               + [Valfritt - Så här skapar du single page-applikationer med AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/create-spa.html?lang=sv-SE)
         ...
         + Innehållsfragment{#content-fragments}
            ...
            + [Variationer - innehåll för redigeringsfragment](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-variations.html?lang=sv-SE)
            + [Markering](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-markdown.html?lang=sv-SE)
            + [Använda associerat innehåll](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-assoc-content.html?lang=sv-SE)
         ...
         + Leverans-API{#delivery-api}
            + [ASSETS HTTP API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/mac-api-assets.html?lang=sv-SE)
            ...
            + [GraphQL API för innehållsfragment](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-api-content-fragments.html?lang=sv-SE)
      ...
      + Utvecklingsverktyg {#devtools}
         ...
         + [AEM Moderniseringsverktyg](/help/sites-developing/modernization-tools.md)
      ...
      + Utöka AEM {#extending-aem}
         ...
         + Utöka Classic UI{#extending-classic-ui}
            ...
            + [Utveckla rapporter](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/platform/dev-reports.html?lang=sv-SE)
      + Testning {#testing}
         ...
         + [Testa användargränssnittet](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/components/hobbes.html?lang=sv-SE)
      + Bästa praxis {#bestpractices}
   ...
   + Distribuerar {#deploying}
      ...
      + Distribuera AEM {#deploying}
         ...
         + [Omindexering offline för AEM](/help/sites-deploying/offline-reindexing.md)
      ...
      + Uppgradera till AEM 6.5 LTS {#upgrading}
         ...
         + [Utvärdera uppgraderingskomplexiteten med AEM Analyzer](/help/sites-deploying/aem-analyzer.md)
         ...
         + [Uppgraderingssteg för programserverinstallationer (Tomcat - Inplace Upgrade)](/help/sites-deploying/app-server-upgrade-tomcat-inplace.md)
