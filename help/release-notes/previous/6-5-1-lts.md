...
>[!IMPORTANT]
>
> **Obligatorisk snabbkorrigering** - Om du vill undvika SNFE-problem (SegmentNotFoundException) med offlinekomprimering när du installerar Service Pack 1 installerar du snabbkorrigeringen som beskrivs i [Kända fel - Databasfel vid onlinekomprimering](#repository-corruption-during-online-compaction-after-offline-compaction-granite-65146).
...
* Oracle Java™ 17/21 (64 bitar) (Mer information finns i avsnittet [Java-stöd](#java-support).
...
>[!NOTE]
>
> (Endast Forms) Oracle Java™ 8/11 (64 bitar) krävs för engångsinstallation.
...
* **FORMS-24688:** När JBoss EAP 8.0 (AEM Forms 6.5.1 LTS) konfigureras i Linux kan skript som skapas eller redigeras i en Windows innehålla CRLF-radslut, vilket orsakar /bin/sh^M: felaktig tolk eller $&#39;\r&#39;: fel hittades inte. Se till att de filer som påverkas använder LF-radslut. Detta kan göras med verktyg som dos2unix eller någon annan likvärdig metod.

* **FORMS-24689:** I turnkey-läge tillämpas inte databasportsuppdateringen korrekt under en ny installation eller uppgradering. I det nya installationsläget kan användare bara välja från de portar som visas på skärmen. I uppgraderingsläget måste den nya databasporten uppdateras manuellt i lc_körkey.xml innan uppgraderingen kan fortsätta.

* **FORMS-24687:** I AEM Forms 6.5 LTS-klusterdistributioner på JBoss EAP 8 kan filerna domain/configuration/domain_oracle.xml, domain_mysql.xml och domain_mssql.xml innehålla en duplicerad `<security>` -tagg, vilket resulterar i ogiltig XML som förhindrar att domänkontrollanten startar.
...
Användarna råkade ut för databasfel vid onlinekomprimering om offlinekomprimering tidigare kördes i JCR-databasen. En `SegmentNotFoundException` (SNFE) kan förekomma i det här scenariot. Det kan leda till att databasen skadas.

Du löser problemet genom att installera snabbkorrigeringen via Package Manager från [Software Distribution](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/cq-6.5.lts.1-hotfix-GRANITE-65385-1.0.zip). Eftersom snabbkorrigeringen innehåller ett paket med `oak-segment-tar` på låg nivå startas instansen om efter installationen.

Planera driftstopp för en instans när den används. För offlinekomprimering använder du motsvarande [Oak-run jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) som också finns i Programvarudistribution.

>[!NOTE]
>
> Använd [Oak-run 1.78.1-B006 jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) (länkad ovan) för alla Oak-körningsåtgärder.
