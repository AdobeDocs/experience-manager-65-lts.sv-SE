...
### Databasfel vid onlinekompaktion efter offlinekomprimering (GRANITE-65146)

Användarna råkade ut för databasfel vid onlinekomprimering om offlinekomprimering tidigare hade körts i JCR-databasen. En `SegmentNotFoundException` (SNFE) kan förekomma i det här scenariot. Det kan leda till att databasen skadas.
...
>[!NOTE]
>
> Använd [oak-run 1.78.1-B006 jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) (länkad ovan) för alla ekkörningsåtgärder.
