...
1. Ange sökvägen till det manliga segmentet, till exempel `/etc/segmentation/ac-segments/male`, och klicka på **OK**. Följande meddelande ska visas: *Upplevelsen är riktad till: Man*
