...
>[!NOTE]
>
>Relationsdatabaser som stöds enligt listan ovan är programvara från tredje part och ingår inte i AEM.
>
...
>[!NOTE]
>
>**NUMA-arkitektur:** System med processorer med AMD64 och Intel® EM64T är vanligtvis konfigurerade som icke-enhetliga minnesarkitekturplattformar (NUMA). Det innebär att kärnan konstruerar flera minnesnoder vid uppstart i stället för att konstruera en enda minnesnod.
>
