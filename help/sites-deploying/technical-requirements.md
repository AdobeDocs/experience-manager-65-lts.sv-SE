...
| MongoDB Enterprise 8.0 | Databas | A: `[2, 3]` stöds |
| MongoDB Enterprise 7.0 | Databas | A: `[2, 3]` stöds |
| MongoDB Enterprise 6.0 | Databas | A: `[2, 3]` stöds |
...
Den lägsta servlet API-version som krävs är Servlet 3.1. Dessutom stöder AEM Forms Jakarta servlet 5 för jar och krig kan köras i programservrar som implementerar Jakarta servlet API 5/6.
...
Adobe Experience Manager stöds när det körs i en virtuell dator i molnmiljöer. Miljöerna omfattar Microsoft® Azure och Amazon Web Services (AWS), som uppfyller de tekniska kraven som listas på den här sidan och som uppfyller Adobe standardsupportvillkor.
...
Adobe erbjuder också Adobe Managed Services för att driftsätta AEM på Azure eller AWS. Adobe Managed Services förser experterna med erfarenhet och kunskaper av att driftsätta och använda AEM i dessa molnmiljöer. Se [ytterligare dokumentation om Adobe Managed Services](https://business.adobe.com/se/products/experience-manager/managed-services.html?aemClk=t).

I alla andra fall där AEM distribueras på Azure eller AWS, eller i någon annan molnbaserad datormiljö, finns stöd från Adobe i den virtuella datormiljön. Den virtuella miljön måste köras i enlighet med de tekniska specifikationer som anges på den här sidan. Alla rapporterade fel som rör AEM som körs i någon av dessa molnmiljöer måste kunna reproduceras oberoende av alla molntjänster som är specifika för molndatormiljön. Det vill säga, om inte molntjänsten stöds som en del av de tekniska krav som anges på den här sidan, till exempel Azure Blob Storage eller AWS S3.
...
### Överväganden för PDF Generator {#software-support-for-pdf-generator}
...
<tr>
   <td>Microsoft® Office 2021 Professional Plus, återförsäljning och volymlicenser</td>
  ...
  <tr>
   ...
   <td>
    ODT, ODP, ODS, ODG, ODF, SXW, SXI, SXC, SXD, XLS, XLSX, DOC, DOCX, PPT, PPTX, bildformat (BMP, GIF, JPEG, JPG, TIF, TIFF, PNG, JPF, JPX, JP2, J2K, JPC, HTML, HTM, RTF och TXT<br>
...
>* PDF Generator-konverteringar för OpenOffice stöds både i Windows och Linux®.
...
Kontakta [AEM Forms support](https://business.adobe.com/in/support/main.html) om du har frågor om format och plattformsversioner som stöds
