...
Följande Java-klass implementerar [PageInfoProvider](https://developer.adobe.com/experience-manager/reference-materials/6-5-lts/javadoc/index.html) och returnerar den publicerade URL:en för den aktuella sidresursen.
