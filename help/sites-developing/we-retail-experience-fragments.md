...
Detta har stöd för det headless Content Management System (CMS) där författare endast vill använda AEM för att skapa, men inte för att leverera till kunden. Ett system/kontaktyta från tredje part kan sedan förbruka upplevelsen och sedan leverera till slutanvändaren.
